...
const serverSchema = z.object({
  ...
  AI_AGENT_FALLBACKS: z.string().optional(),
  AI_AGENT_INGESTION: z.string().optional(),
  AI_AGENT_SOURCE_AUDITOR: z.string().optional(),
  AI_AGENT_CURRICULUM: z.string().optional(),
  AI_AGENT_TECHNICAL_VERIFIER: z.string().optional(),
  AI_AGENT_TECHNICAL_WRITER: z.string().optional(),
  AI_AGENT_TEACHING: z.string().optional(),
  AI_AGENT_VISUAL_ART_DIRECTOR: z.string().optional(),
  AI_AGENT_TECHNICAL_DIAGRAM: z.string().optional(),
  AI_AGENT_ILLUSTRATION: z.string().optional(),
  AI_AGENT_COVER: z.string().optional(),
  AI_AGENT_EDITORIAL_REVIEWER: z.string().optional(),
  AI_AGENT_PUBLISHING: z.string().optional(),
  AI_IMAGE_PROVIDER: z.enum(['mock', 'openai']).default('mock'),
  AI_IMAGE_MODEL: z.string().min(1).default('mock-image-1'),
  // Ricerca web. Il provider simulato non inventa risultati: restituisce un
  // elenco vuoto e lo dichiara.
  AI_SEARCH_PROVIDER: z.enum(['mock', 'anthropic', 'openai', 'gemini']).default('mock'),
  AI_SEARCH_MODEL: z.string().min(1).default('claude-sonnet-5'),
...
export function getServerEnv(): ServerEnv {
  ...
  const parsed = serverSchema.safeParse({
    ...
    AI_AGENT_FALLBACKS: process.env.AI_AGENT_FALLBACKS,
    AI_AGENT_INGESTION: process.env.AI_AGENT_INGESTION,
    AI_AGENT_SOURCE_AUDITOR: process.env.AI_AGENT_SOURCE_AUDITOR,
    AI_AGENT_CURRICULUM: process.env.AI_AGENT_CURRICULUM,
    AI_AGENT_TECHNICAL_VERIFIER: process.env.AI_AGENT_TECHNICAL_VERIFIER,
    AI_AGENT_TECHNICAL_WRITER: process.env.AI_AGENT_TECHNICAL_WRITER,
    AI_AGENT_TEACHING: process.env.AI_AGENT_TEACHING,
    AI_AGENT_VISUAL_ART_DIRECTOR: process.env.AI_AGENT_VISUAL_ART_DIRECTOR,
    AI_AGENT_TECHNICAL_DIAGRAM: process.env.AI_AGENT_TECHNICAL_DIAGRAM,
    AI_AGENT_ILLUSTRATION: process.env.AI_AGENT_ILLUSTRATION,
    AI_AGENT_COVER: process.env.AI_AGENT_COVER,
    AI_AGENT_EDITORIAL_REVIEWER: process.env.AI_AGENT_EDITORIAL_REVIEWER,
    AI_AGENT_PUBLISHING: process.env.AI_AGENT_PUBLISHING,
    AI_IMAGE_PROVIDER: process.env.AI_IMAGE_PROVIDER,
    AI_IMAGE_MODEL: process.env.AI_IMAGE_MODEL,
    AI_SEARCH_PROVIDER: process.env.AI_SEARCH_PROVIDER,
    AI_SEARCH_MODEL: process.env.AI_SEARCH_MODEL,
